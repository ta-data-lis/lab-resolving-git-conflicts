NEW BRANCH - MODIFIED TO PROVOKE A CONFLICT, FIXED AFTERWARDS ----
    ...
    ```
    # Who am I: Rita Pereira

    * Where are you from? Faro, Algarve
    * What do you do? Analyst 
    * Do you have previous experience with technology/data? Not much 

    # Why am I here want to learn how to code

    * What has brought you to Ironhack? community 
    * What knowledge/skills do you expect to learn in this bootcamp?

    # What will I do after the bootcamp? change carreer 
